function navClass(page){ return page; }
  ...
  <div class="admin-layout">
    <aside class="sidebar">
      <div class="brand">
        ...
        <div class="brand__text"><strong>Aplus Admin</strong><span>內容獲客後台</span></div>
      </div>
      <nav>
      ...
      <div class="nav-footer">前台預覽：<a href="../blog.html" target="_blank">blog.html</a></div>
    </aside>
    <div class="main">
      <header class="topbar">
...
window.AdminCommon = { renderLayout, formatDate, escapeHtml, statusBadge, openModal, closeModal };
